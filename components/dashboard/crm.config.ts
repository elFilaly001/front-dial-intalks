...
export const leadsBySourceChartData = [
  { source: "website", leads: 170, fill: "#1877F2" },
  { source: "referral", leads: 105, fill: "#E4405F" },
  { source: "social", leads: 90, fill: "#FF0000" },
  { source: "cold", leads: 62, fill: "#FFC107" },
  { source: "other", leads: 48, fill: "#9E9E9E" },
];
